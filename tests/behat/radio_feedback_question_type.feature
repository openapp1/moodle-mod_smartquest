@mod @mod_smartquest
Feature: In smartquest, radio questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a smartquest with a radio question type and verify that feedback options exist.
