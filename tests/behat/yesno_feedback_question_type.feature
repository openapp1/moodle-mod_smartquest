@mod @mod_smartquest
Feature: In smartquest, yes/no questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a smartquest with a yes/no question type and verify that feedback options exist.
