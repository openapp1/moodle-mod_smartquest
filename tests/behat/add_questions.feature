@mod @mod_smartquest
Feature: Add questions to a smartquest activity
  In order to conduct surveys of the users in a course
  As a teacher
  I need to add a smartquest activity with questions to a moodle course

@javascript
  Scenario: Add a smartquest to a course with one of each question type
