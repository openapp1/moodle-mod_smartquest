@mod @mod_smartquest
Feature: In smartquest, personality tests can be constructed using feedback on specific question responses.
  In order to define a feedback smartquest
  As a teacher
  I must add the required question types and complete the feedback options.

  @javascript
  Scenario: Create a smartquest with a rate question type and verify that feedback options exist.
