...
class text extends base {
    static public function response_table() {
        return 'smartquest_response_text';
    }
    ...
    public function display_results($rids=false, $sort='', $anonymous=false) {
        ...
        if ($rows = $this->get_results($rids, $anonymous)) {
            ...
            if ($isnumeric) {
                $output .= \mod_smartquest\response\display_support::mkreslistnumeric($this->counts, count($rids),
                    $this->question->precise);
            } else {
                $output .= \mod_smartquest\response\display_support::mkreslisttext($rows);
            }
        } else {
