...
class rate extends base {
    ...
    protected function responseclass() {
        return '\\mod_smartquest\\response\\rank';
    }
    ...
    public function question_template() {
        return 'mod_smartquest/question_rate';
    }
    ...
    public function response_template() {
        return 'mod_smartquest/response_rate';
    }
    ...
    protected function form_precise(\MoodleQuickForm $mform, $helptext = '') {
        ...
        $mform->addElement('select', 'precise', get_string('kindofratescale', 'smartquest'), $precoptions);
        $mform->addHelpButton('precise', 'kindofratescale', 'smartquest');
