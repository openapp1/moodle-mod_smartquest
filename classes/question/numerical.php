...
class numerical extends base {
    ...
    public function question_template() {
        return 'mod_smartquest/question_numeric';
    }
    ...
    public function response_template() {
        return 'mod_smartquest/response_numeric';
    }
        ...
        if (isset($data->{'q'.$this->id})) {
            ...
            if ($mynumber != '') {
                ...
                if (!is_numeric($mynumber) ) {
                    $msg = get_string('notanumber', 'smartquest', $mynumber);
                    ...
                    if ( $mynumber != $mynumber0) {
                        ...
                        $msg = get_string('numberfloat', 'smartquest', $a);
                        $this->add_notification($msg);
                    }
                }
            }
