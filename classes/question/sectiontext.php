...
class sectiontext extends base {
    ...
    public function question_template() {
        return 'mod_smartquest/question_sectionfb';
    }
    ...
    protected function question_survey_display($data, $descendantsdata, $blanksmartquest=false) {
        ...
        if (!isset($data->smartquest_id)) {
            return '';
        }

        $fbsections = $DB->get_records('smartquest_fb_sections', ['survey_id' => $this->survey_id]);
        $filteredsections = [];
        ...
        list($cm, $course, $smartquest) = smartquest_get_standard_page_items(null, $data->smartquest_id);
        ...
        $feedbackmessages = $smartquest->response_analysis($rid, $resps, $compare, $isgroupmember, $allresponses,
