...
/**
 * The mod_smartquest all_responses_viewed event.
 *
...
/**
 * The mod_smartquest all_responses_viewed event class.
 *
...
class all_responses_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_all_responses_viewed', 'mod_smartquest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the all responses report for the smartquest
    ...
    public function get_url() {
        ...
        return new \moodle_url("/mod/smartquest/report.php", $params);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, "smartquest", "view report", "report.php?id=" . $this->contextinstanceid, $this->objectid,
