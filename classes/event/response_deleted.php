...
/**
 * The mod_smartquest response_deleted viewed event.
 *
...
/**
 * The mod_smartquest response_deleted event class.
 *
 * @package    mod_smartquest
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class response_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_response_deleted', 'mod_smartquest');
    }
