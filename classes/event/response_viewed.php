...
/**
 * The mod_smartquest response_viewed event.
 *
...
/**
 * The mod_smartquest response_viewed event class.
 *
 * @package    mod_smartquest
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class response_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_individual_responses_viewed', 'mod_smartquest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the individual responses report for user with id '$this->relateduserid'
            to the smartquest with course module id '$this->contextinstanceid'.";
    }
