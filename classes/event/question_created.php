...
/**
 * The mod_smartquest question_created event.
 *
...
/**
 * The mod_smartquest question_created event class.
 *
 * @package    mod_smartquest
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class question_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_created', 'mod_smartquest');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has created or modified a question of type '$questiontype' for
            the smartquest with course module id '$this->contextinstanceid'.";
    }
}