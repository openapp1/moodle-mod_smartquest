 ...
 */
class moodle1_mod_smartquest_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'smartquest', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
            ...
            new convert_path('survey', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY'),
            new convert_path('question', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY/QUESTION'),
            new convert_path('question_choice', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY/QUESTION/QUESTION_CHOICE'),
        );
    }
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST
     * data available
     */
    public function process_smartquest($data) {
        ...
        $this->open_xml_writer("activities/smartquest_{$moduleid}/smartquest.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'smartquest', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('smartquest', array('id' => $instanceid));
    ...
    /**
     * This is executed when we reach the closing </MOD> tag of our 'smartquest' path
     */

    public function on_smartquest_end() {
        // Close smartquest.xml.
        $this->xmlwriter->end_tag('surveys');
        $this->xmlwriter->end_tag('smartquest');
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();
    }
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY
     * data available
     */
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY/QUESTION
     * data available
     */
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SMARTQUEST/SURVEY/QUESTION/QUESTION_CHOICE
     * data available
     */
