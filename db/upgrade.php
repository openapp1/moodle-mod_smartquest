...
function xmldb_smartquest_upgrade($oldversion=0) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2007120101) {
        $result &= smartquest_upgrade_2007120101();

        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2007120101, 'smartquest');
    }

    if ($oldversion < 2007120102) {
        // Change enum values to lower case for all tables using them.
        $table = new xmldb_table('smartquest_question');
        ...
        $DB->set_field('smartquest_question', 'required', 'y', array('required' => 'Y'));
        $DB->set_field('smartquest_question', 'required', 'n', array('required' => 'N'));
        ...
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_question', 'deleted', 'y', array('deleted' => 'Y'));
        $DB->set_field('smartquest_question', 'deleted', 'n', array('deleted' => 'N'));
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, XMLDB_ENUM, array('y', 'n'), 'n');
        $dbman->change_field_enum($table, $field);
        $dbman->change_field_default($table, $field);
        unset($field);
        ...
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_question', 'public', 'y', array('public' => 'Y'));
        $DB->set_field('smartquest_question', 'public', 'n', array('public' => 'N'));
        ...
        $table = new xmldb_table('smartquest_question_type');

        $field = new xmldb_field('has_choices');
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_question_type', 'has_choices', 'y', array('has_choices' => 'Y'));
        $DB->set_field('smartquest_question_type', 'has_choices', 'n', array('has_choices' => 'N'));
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, XMLDB_ENUM, array('y', 'n'), 'y');
        $dbman->change_field_enum($table, $field);
        $dbman->change_field_default($table, $field);
        unset($field);
        ...
        $table = new xmldb_table('smartquest_response');

        $field = new xmldb_field('complete');
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_response', 'complete', 'y', array('complete' => 'Y'));
        $DB->set_field('smartquest_response', 'complete', 'n', array('complete' => 'N'));
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, XMLDB_ENUM, array('y', 'n'), 'n');
        $dbman->change_field_enum($table, $field);
        $dbman->change_field_default($table, $field);
        unset($field);
        ...
        $table = new xmldb_table('smartquest_response_bool');

        $field = new xmldb_field('choice_id');
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_response_bool', 'choice_id', 'y', array('choice_id' => 'Y'));
        $DB->set_field('smartquest_response_bool', 'choice_id', 'n', array('choice_id' => 'N'));
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, XMLDB_ENUM, array('y', 'n'), 'y');
        $dbman->change_field_enum($table, $field);
        $dbman->change_field_default($table, $field);
        unset($field);
        ...
        $table = new xmldb_table('smartquest_survey');

        $field = new xmldb_field('public');
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, false, null, 'n');
        $dbman->change_field_enum($table, $field);
        $DB->set_field('smartquest_survey', 'public', 'y', array('public' => 'Y'));
        $DB->set_field('smartquest_survey', 'public', 'n', array('public' => 'N'));
        $field->set_attributes(XMLDB_TYPE_CHAR, '1', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, XMLDB_ENUM, array('y', 'n'), 'y');
        $dbman->change_field_enum($table, $field);
        $dbman->change_field_default($table, $field);
        unset($field);
        ...
        $DB->set_field('smartquest_question_type', 'response_table', 'resp_single',
                        array('response_table' => 'response_single'));
        $DB->set_field('smartquest_question_type', 'response_table', 'resp_multiple',
                        array('response_table' => 'response_multiple'));

        // Smsrtquest savepoint reached..
        upgrade_mod_savepoint(true, 2007120102, 'smartquest');
    }

    if ($oldversion < 2008031902) {
        $table = new xmldb_table('smartquest');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008031902, 'smartquest');
    }
    ...
    if ($oldversion < 2008031904) {
        ...
        if ($rs = $DB->get_recordset_sql($sql)) {
            ...
            $capview = 'mod/smartquest:view';
            $capsubmit = 'mod/smartquest:submit';

            foreach ($rs as $smartquest) {
                $context = get_context_instance(CONTEXT_MODULE, $smartquest->cmid);

                // Convert smartquests with resp_eligible = 'all' so that students & teachers have view and submit.
                if ($smartquest->resp_eligible == 'all') {
                    ...
                    // Convert smartquests with resp_eligible = 'students' so that just students have view and submit.
                } else if ($smartquest->resp_eligible == 'teachers') {
                    assign_capability($capsubmit, CAP_ALLOW, $editteacherroleid, $context->id, true);
                    assign_capability($capsubmit, CAP_ALLOW, $teacherroleid, $context->id, true);
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008031904, 'smartquest');
    }
    ...
    if ($oldversion < 2008031905) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008031905, 'smartquest');
    }

    if ($oldversion < 2008031906) {
        $table = new xmldb_table('smartquest_response_rank');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008031906, 'smartquest');
    }
    ...
    if ($oldversion < 2008060401) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008060401, 'smartquest');
    }
    ...
    if ($oldversion < 2008070702) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008070702, 'smartquest');
    }

    if ($oldversion < 2008070703) {
        $table = new xmldb_table('smartquest_resp_multiple');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008070703, 'smartquest');
    }
    ...
    if ($oldversion < 2008070704) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008070704, 'smartquest');
    }
    ...
    if ($oldversion < 2008070705) {
        ...
        $DB->set_field('smartquest', 'introformat', 1);

        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008070705, 'smartquest');
    }
    ...
    if ($oldversion < 2008070706) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2008070706, 'smartquest');
    }

    if ($oldversion < 2010110100) {
        // Drop list of values (enum) from field has_choices on table smartquest_question_type.
        $table = new xmldb_table('smartquest_question_type');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2010110100, 'smartquest');
    }

    if ($oldversion < 2010110101) {
        // Drop list of values (enum) from field respondenttype on table smartquest.
        $table = new xmldb_table('smartquest');
        ...
        $dbman->drop_enum_from_field($table, $field);
        // Drop list of values (enum) from field resp_eligible on table smartquest.
        ...
        // Drop list of values (enum) from field required on table smartquest_question.
        $table = new xmldb_table('smartquest_question');
        ...
        $dbman->drop_enum_from_field($table, $field);
        // Drop list of values (enum) from field deleted on table smartquest_question.
        ...
        // Drop list of values (enum) from field complete on table smartquest_response.
        $table = new xmldb_table('smartquest_response');
        ...
        // Drop list of values (enum) from field choice_id on table smartquest_response_bool.
        $table = new xmldb_table('smartquest_response_bool');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2010110101, 'smartquest');
    }

    if ($oldversion < 2012100800) {
        // Changing precision of field name on table smartquest_survey to (255).
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2012100800, 'smartquest');
    }

    if ($oldversion < 2013062302) {
        // Adding completionsubmit field to table smartquest.
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2013062302, 'smartquest');
    }

    if ($oldversion < 2013062501) {
        // Skip logic new feature.
        // Define field dependquestion to be added to smartquest_question table.
        $table = new xmldb_table('smartquest_question');
        ...
        $choices = $DB->get_recordset('smartquest_quest_choice', null);
        $total = $DB->count_records('smartquest_quest_choice');
        if ($total > 0) {
            ...
            foreach ($choices as $choice) {
                if (($choice->value == null || $choice->value == 'NULL')
                    ...
                    $content = smartquest_choice_values($choice->content);
                    if (strpos($content->text, '=')) {
                        $newcontent = str_replace('=', '::', $content->text);
                        $choice->content = $newcontent;
                        $DB->update_record('smartquest_quest_choice', $choice);
                    }
                }
                $pbar->update($i, $total, "Convert smartquest choice value separator - $i/$total.");
                $i++;
            }
        }

        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2013062501, 'smartquest');
    }
    ...
    if ($oldversion < 2013100500) {
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2013100500, 'smartquest');
    }
    ...
    if ($oldversion < 2013122202) {
        ...
        // Define table smartquest_fb_sections to be created.
        $table = new xmldb_table('smartquest_fb_sections');
        ...
        // Adding keys to table smartquest_fb_sections.
        ...
        // Define table smartquest_feedback to be created.
        $table = new xmldb_table('smartquest_feedback');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2013122202, 'smartquest');
    }
    ...
    if ($oldversion < 2014010300) {
        ...
        // Smsrtquest savepoint reached.
         upgrade_mod_savepoint(true, 2014010300, 'smartquest');
    }

    if ($oldversion < 2015051101) {
        // Move the global config value for 'usergraph' to the plugin config setting instead.
        if (isset($CFG->smartquest_usergraph)) {
            set_config('usergraph', $CFG->smartquest_usergraph, 'smartquest');
            unset_config('smartquest_usergraph');
        }
        upgrade_mod_savepoint(true, 2015051101, 'smartquest');
    }

    // Add index to reduce load on the smartquest_quest_choice table.
    if ($oldversion < 2015051102) {
        // Conditionally add an index to the question_id field.
        $table = new xmldb_table('smartquest_quest_choice');
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2015051102, 'smartquest');
    }
    ...
    if ($oldversion < 2016020204) {
        ...
        $table = new xmldb_table('smartquest_response_date');
        $field = new xmldb_field('response', XMLDB_TYPE_TEXT, null, null, null, null, null);
        $dbman->change_field_precision($table, $field);

        // Smsrtquest savepoint reached.
         upgrade_mod_savepoint(true, 2016020204, 'smartquest');
    }
    ...
    if ($oldversion < 2016111105) {
        ...
        // Smsrtquest savepoint reached.
         upgrade_mod_savepoint(true, 2016111105, 'smartquest');
    }
    ...
    if ($oldversion < 2017050101) {
        ...
        if ($dbman->field_exists($table, $field)) {
            ...
            $sql = 'SELECT qr.id, qr.username, qa.rid, qa.userid ' .
                   ...
                   'INNER JOIN {smartquest_attempts} qa ON qr.id = qa.rid ' .
                   'WHERE qr.username = ?';
            $rs = $DB->get_recordset_sql($sql, ["Anonymous"]);
            // Set all "Anonymous" records to the userid in the matching attempt record.
            foreach ($rs as $record) {
                $DB->set_field('smartquest_response', 'username', "{$record->userid}", ['id' => $record->id]);
            }
            // If there are any leftover "Anonymous" records, set them all to userid zero (there shouldn't be).
            $rs = $DB->get_recordset('smartquest_response', ['username' => 'Anonymous']);
            foreach ($rs as $record) {
                $DB->set_field('smartquest_response', 'username', '0', ['id' => $record->id]);
            }
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2017050101, 'smartquest');
    }

    // Converting to new dependency system.
    if ($oldversion < 2017111101) {
        // MOD Multiparent Advanceddependencies START.
        // Define table smartquest_dependency to be created.
        $table = new xmldb_table('smartquest_dependency');

        // Adding fields to table smartquest_depenencies.
        ...
        // Adding keys to table smartquest_depenencies.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Adding indexes to table smartquest_dependency.
        $table->add_index('quest_dependency_quesidx', XMLDB_INDEX_NOTUNIQUE, array('questionid'));

        // Conditionally launch create table for smartquest_dependencies.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);

            // Copy all existing branching data into new branching structure.
            $branchingrs = $DB->get_recordset_select('smartquest_question', 'dependquestion > 0 AND deleted = \'n\'',
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2017111101, 'smartquest');
    }
    
    if ($oldversion < 2017111105) {
        $table = new xmldb_table('smartquest_survey');
        $field = new xmldb_field('anonymoustemplate');
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, true, false, false, null, 0);
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
        unset($table);
        ...
        $table = new xmldb_table('smartquest');
        $field = new xmldb_field('rtype');
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, true, false, 0, 'introformat');
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }

        unset($field);
        $field = new xmldb_field('sapevent_id');
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, true, false, 0, 'rtype');
        if (!$dbman->field_exists($table, $field)) {            
            $dbman->add_field($table, $field);
        }
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, true, false, 0, 'sapevent_id');
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
        ...
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, true, false, 0, 'role_id');
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }

        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2017111105, 'smartquest');
    }

    if ($oldversion < 2017111108) {
        $table = new xmldb_table('smartquest_response');
        $field = new xmldb_field('aboutuserid');
        $field->set_attributes(XMLDB_TYPE_INTEGER, '10', false, false, false, 0);
        ...
        // Smsrtquest savepoint reached.
        upgrade_mod_savepoint(true, 2017111108, 'smartquest');
    }

    if ($oldversion < 2017111109) {
        // Define table hvp_tmpfiles to be created.
        $table = new xmldb_table('smartquest_response_relrank');
        
        // Adding fields to table hvp_tmpfiles.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('response_id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, false, null);
        $table->add_field('question_id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, false, null);
        $table->add_field('choice_id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, false, null);
        $table->add_field('rank', XMLDB_TYPE_INTEGER, '11', null, XMLDB_NOTNULL, false, null);
        $table->add_field('reason', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, false, null);
        ...
        upgrade_mod_savepoint(true, 2017111109, 'smartquest');
    }
...
function smartquest_upgrade_2007120101() {
    global $DB;
    ...
    $qtable = new xmldb_table('smartquest_question_choice');
    $dbman->rename_table($qtable, 'smartquest_quest_choice', false);
    unset($qtable);

    $qtable = new xmldb_table('smartquest_response_multiple');
    $dbman->rename_table($qtable, 'smartquest_resp_multiple', false);
    unset($qtable);

    $qtable = new xmldb_table('smartquest_response_single');
    $dbman->rename_table($qtable, 'smartquest_resp_single', false);
    unset($qtable);

    // Upgrade the smartquest_question_type table to use typeid.
    $table = new xmldb_table('smartquest_question_type');
    $field = new xmldb_field('typeid');
    $field->set_attributes(XMLDB_TYPE_CHAR, '20', true, true, false, false, null, '0', 'id');
    $dbman->add_field($table, $field);
    if (($numrecs = $dbman->count_records('smartquest_question_type')) > 0) {
        $recstart = 0;
        $recstoget = 100;
        while ($recstart < $numrecs) {
            if ($records = $dbman->get_records('smartquest_question_type', array(), '', '*', $recstart, $recstoget)) {
                foreach ($records as $record) {
                    $dbman->set_field('smartquest_question_type', 'typeid', $record->id, array('id' => $record->id));
                }
            }
            $recstart += $recstoget;
        }
