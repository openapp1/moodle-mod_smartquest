...
function xmldb_smartquest_install() {
    global $DB;
    ...
    $id = $DB->insert_record('smartquest_question_type', $questiontype);
    ...
    $questiontype->type = 'Relevant Rate (scale 1..5)';
    $questiontype->has_choices = 'y';
    $questiontype->response_table = 'response_relrank';
    $id = $DB->insert_record('smartquest_question_type', $questiontype);
